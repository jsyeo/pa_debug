...
(* OASIS_START *)
(* DO NOT EDIT (digest: bb3c2f41d1f4428028355d0efe298f7c) *)
(*
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("deriving-ocsigen.base", None);
                           FindlibPackage ("camlp4.lib", None);
                           FindlibPackage ("debuglib", None)
                        ];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4of"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Pa_debug"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "pa_debug_lib";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "Í HPS\b\\\157P3\129Ô¯\021K5";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
